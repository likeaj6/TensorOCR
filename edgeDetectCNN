...
def avg_pool_5x5(x):
    return tf.nn.avg_pool(x, ksize=[1, 5, 5, 1], strides=[1, 5, 5, 1], padding='SAME')
...
#1024 inputs for pixels, 10 outputs
...
W_conv1 = weight_variable([8, 8, 1, 96])
...
h_pool1 = avg_pool_5x5(h_conv1)

print("First Conv Layer" + h_conv1.get_shape())
print("Avg Pooling" + h_pool1.get_shape())
#
# W_conv2 = weight_variable([8, 8, 96, 256])
# b_conv2 = bias_variable([256])
#
# h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
# h_pool2 = avg_pool_2x2(h_conv2)
#
# W_fc1 = weight_variable([25 * 25 * 96, 1024])
